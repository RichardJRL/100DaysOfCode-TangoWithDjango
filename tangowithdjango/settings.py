...
SECRET_KEY = 'django-insecure-c_0%74yo&075!i9h!irhj41_amxyvkfs$1vn@+i#a4f-t40pi9'
...
INSTALLED_APPS = [
    ...
    # PyCharm has autogenerated 'rango.apps.RangoConfig' but Tango With Django asks for 'rango' here.
...
# Media files (Dynamic image, video files etc.)
MEDIA_URL = '/media/'
